...
public class AdminController {
	...
	@Autowired
	public AdminController(ScreenPlayService screenPlayService, UserService userService) {
	...
	@PreAuthorize("hasAuthority('add:screenPlay')")
	...
	@PreAuthorize("hasAuthority('update:screenPlay')")
